...
<?
  ...
  <?
   ...
   <input TYPE="submit" name="powrot1" value="Powr�t do sklepu">
  ...
  <?
  $cena57+=9;
   $message="Zamowienie. \n\nDzien dobry.\n\n Potwierdzamy panstwa zamowienie w naszym sklepie.\n\n Na poczcie (lub listonoszowi) trzeba bedzie zaplacic $cena57 ";
   mail($emailx, 'SPotwierdzenie', $message,
     "From: admin",
     "-fadmin@");
...
//		where klimat='$klima' order by nr",$db);
	...
	&nbsp <A HREF="index1.php?impry=yes" NAME="Zdj�cia z imprez" TARGET="_top" TITLE="Zdj�cia z imprez" STYLE="font-size: 12px; font-family: Times New Roman">Zdj�cia z imprez</A>
	...
	&nbsp <A HREF="mailto:biuro@" STYLE="font-family: Times New Roman; font-size: 12px; color: #FFFFFF">Napisz do nas</A>
	</TD>
	</TR>
	<tr>
...
<form ACTION="index1.php">
		...
		{
		?>
		<A HREF="index1.php?widok=przod" TITLE="Prz�d"><SPAN STYLE=" font-family: Times New Roman; font-size: 12px; color: #66CCFF">
		Prz�d
		</SPAN>
		</A>, &nbsp
...
//	Potwierdzenie zamawiania z logowaniem
	...
	<TD ALIGN="CENTER">
	<A HREF="newuser.php" TARGET="_blank" TITLE="Nowy u�ytkownik" STYLE="color: #33FFFF; font-size: 16px; font-family: Times New Roman">Nowy u�ytkownik, zarejestruj si� w 2 minuty</A>
	</TD>
	</TR>
	<tr>
	<td>
	...
	Mo�esz zamawia� przedmioty i p�aci� dopiero przy odbiorze (za pobraniem).
	</SPAN>
	</center>
	</FORM>
...
// FORMULARZ ZAMAWIANIA
	...
	<SPAN STYLE=" font-family: Times New Roman; font-size: 16px; color: #FF99FF">
	<center>
	<input TYPE="submit" name="login" value="Zaloguj si�">
	</CENTER>
	<br>
	LUB<br>
...
Szpenio wydrukowa� Ci Tw�j ulubiony motor!!!
<HR ALIGN="CENTER" SIZE="1" WIDTH="90" COLOR="#CCCCFF">
T-SHIRTY
r�cznie malowane, wykonane przez profesjonaliste.<br>
Oryginalne wzory, kt�re widniej� po obu stronach koszulki.
<HR ALIGN="CENTER" SIZE="1" WIDTH="90" COLOR="#CCCCFF">
...
<br><br>
Wystawa motocykli i skuter�w w WARSZAWIE. MOTOR BIKE SHOW POLAND 2005.<br><br>
